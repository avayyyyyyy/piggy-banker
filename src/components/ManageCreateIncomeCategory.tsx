...
import { saveCategoryIncome } from "../lib/actions";
import { toast } from "sonner";
import { Loader } from "lucide-react";
import { useRouter } from "next/navigation";

function NewExpenseManage() {
  ...
  const { mutate: saveCategoryFnc, isPending: categoryLoading } = useMutation({
    mutationKey: ["saveCategoryIncome"],
    mutationFn: async () => {
  ...
  return (
    <div>
      <Dialog open={categoryOpen} onOpenChange={setCategoryOpen}>
        ...
        <DialogContent className="max-w-[80vw] md:max-w-[425px]   rounded-lg">
          <DialogHeader>
...
export default NewExpenseManage;
